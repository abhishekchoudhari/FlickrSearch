//
//  FlickrCollectionViewLayout.swift
//  FlickrSearch
//
...
class TwoColumnLayoutMetrics: FlickrLayoutMetrics {
    func numberOfRowsForNumberOfItems(numberOfItems: Int) -> Int {
...
class OneColumnLayoutMetrics: FlickrLayoutMetrics {
    func numberOfRowsForNumberOfItems(numberOfItems: Int) -> Int {
...
enum FlickrLayoutType {
    case OneColumn
    case TwoColumn
    
    func metrics() -> FlickrLayoutMetrics {
        switch self {
        case OneColumn:
...
class FlickrCollectionViewLayout: UICollectionViewLayout {
    ...
    var layoutType: FlickrLayoutType
    var layoutMetrics: FlickrLayoutMetrics
    
    init(type: FlickrLayoutType) {
        layoutType = type
